...
public class WallsOutsideTheGateLeftandRight : MonoBehaviour
{
    // Wall and Panel
    ...
    void Update()
    {
        ...
        // Move the panel according to the player's z position
        panel.transform.position = new Vector3(panel.transform.position.x, panel.transform.position.y, player.transform.position.z);
    }
}